                    ...
                    <div class="card">
                        <div class="header">
                            <h2>
                                ...
                                <small>You Can Insert / Input, Update, and Delete the Testimonial for Employees' Activty Here</small>
                            </h2>
                            <div class="col-xs-offset-8 col-sm-offset-8 col-md-offset-8 col-lg-offset-8">
                                <div style="margin-bottom: -10px" class="input-group">
                                    ...
                                    <div class="form-line">
                                    <form method="get" action="{{url($view_path.'/testimonial')}}">
                        ...
                        <div class="body">
                            <div class="container-fluid">
                                <a href="{{url($view_path.'/testimonial/create')}}">
                                    <button style="margin-left: 10px;" class="btn btn-primary pull-right">Insert Testimony</button>
                                </a>
                                <a class="pull-right" href="{{url($view_path.'/testimonial/sorting')}}">
                                    <button class="btn btn-info">Sort Testimonial Order</button>
                                </a>
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <table class="table table-striped table-hover">
                                        <thead>
                                            <tr> 
                                                ...
                                                <th>Position
                                                    @if(Request::input('order') == 'desc')
                                                        <a href="{{ Request::fullUrlWithQuery(['sort' => 'position','order' => 'asc']) }}"> <i class="fa fa-angle-up"></i>
                                                        </a>
                                                    @else
                                                        <a href="{{ Request::fullUrlWithQuery(['sort' => 'position','order' => 'desc']) }}"> <i class="fa fa-angle-down"></i>
                                                        </a>
                                                    @endif
                                                </th>
                                                <th>Order
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="{{url($view_path.'/testimonial/'.$key->id)}}" method="post">
                                                        <button class="btn btn-info">Update</button>
                                                        {{ method_field('get') }}
                                                    </form>
                                                </td>
                                                <td>
                                                    <form class="delete" action="{{url($view_path.'/testimonial/'.$key->id)}}" method="post">
                                    ...
                                    <div class="col-md-offset-4">
                                        {{$testimonial->appends(Request::query())->links()}}
                                    </div>
                                </div>
                            </div>
                        </div>
