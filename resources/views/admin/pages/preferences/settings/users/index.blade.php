            ...
            <div class=".col-xs-12 .col-sm-6 .col-md-8">
                <div class="card">
                    <div class="header">
                        <h2>
                            User Settings
                            <small>You Can Insert / Input, Update, and Delete the Registered Users Here</small>
                        </h2>
                        <div class="col-xs-offset-8 col-sm-offset-8 col-md-offset-8 col-lg-offset-8">
                            <div style="margin-bottom: -10px" class="input-group">
                                ...
                                <div class="form-line">
                                <form method="get" action="{{url($view_path.'/users')}}">
                    ...
                    <div class="body">
                        <div class="container-fluid">
                            <a href="{{url($view_path.'/users/create')}}"><button class="btn btn-primary pull-right">Insert User</button></a>
                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$key->email}}</td>
                                            <td>
                                                <form action="{{url($view_path.'/users/'.$key->id)}}" method="post">
                                            ...
                                            <td>
                                                <form class="delete" action="{{url($view_path.'/users/'.$key->id)}}" method="post">
