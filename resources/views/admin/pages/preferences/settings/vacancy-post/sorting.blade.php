...
@section('content')
<form method="post" class="update" action="{{url($view_path.'/vacancy-post/doSorting')}}">
    {!!csrf_field()!!}
                ...
                <div class=".col-xs-12 .col-sm-6 .col-md-8">
                    <div class="card">
                        <div class="header">
                            ...
                            <h2>
                                Sort Vacancy Post Order
                                <small>You Can Sort the Vacancy Post Order Here</small>
                            </h2>
                        </div>
                        <div class="body">
                                    ...
                                    <ul id="sortable">
                                        @foreach($vacancypost as $key)
                                            ...
                                            <li class="ui-state-default">
                                                <h6 style="padding-bottom: -10px;">{{$key->order}}</h6>
                                                <h5 data-toggle="tooltip" data-placement="bottom" title="{{$key->title}}" >
