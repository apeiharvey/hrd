...
@section('content')
<form class="insert" action="{{url($view_path.'/vacancy-category')}}" method="post" enctype="multipart/form-data">
    {!!csrf_field()!!}
                ...
                <div class=".col-xs-12 .col-sm-6 .col-md-8">
                    <div class="card">
                        <div class="header">
                            ...
                            <h2>
                                Insert Vacancy Category
                                <small>You Can Insert / Input The Vacancy Category Here</small>
                            </h2>
                        </div>
                        <div class="body">
                            <div class="tab-content">
                                <div class="row clearfix">
                                    ...
                                    {!!view($view_path.'.builder.textarea',['name' => 'name_alias','form_class' => 'col-sm-12','value' => '', 'placeholder' => 'Alias'])!!}
