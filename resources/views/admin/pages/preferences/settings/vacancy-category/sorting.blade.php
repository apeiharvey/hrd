...
@section('content')
<form method="post" class="update" action="{{url($view_path.'/vacancy-category/doSorting')}}">
    {!!csrf_field()!!}
                ...
                <div class=".col-xs-12 .col-sm-6 .col-md-8">
                    <div class="card">
                        <div class="header">
                            ...
                            <h2>
                                Sort Vacancy Category Order
                                <small>You Can Sort the Vacancy Category Order Here</small>
                            </h2>
                        </div>
                        <div class="body">
