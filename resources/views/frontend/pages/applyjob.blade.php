...
@section('content')
	<div class="container m-b-24">
		<div class="row">
			<div class="col-xs-12 m-t-24 text-center ">
				<h1 class="main-title">{{$vacancypost->title}}</h1>
			</div>
		</div>
	</div>
	<!--TINGGAL TAMBAH BACKGROUND-->
	<div class="container-fluid">
		<div class="row">
			<div class="col-xs-12 m-t-8 m-b-8 text-center ">
				<h1 class="responsibilities-title">Responsibilities</h1>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-10 col-md-offset-1 col-lg-6 col-lg-offset-3 m-t-8">
				<div class="centering-desc">
					<div class="font-18 padding-8">{!!$vacancypost->responsibilities!!}
					</div>
				</div>
			</div>
		</div>
	...
	<div class="container-fluid m-b-10">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-10 col-md-offset-1 col-lg-6 col-lg-offset-3 m-t-8">
				<div class="centering-desc">
					<div class="font-18 padding-8">{!!$vacancypost->requirements!!}
					</div>
				</div>
			</div>
		</div>
	...
	<div class="container-fluid">
		<div class="row m-t-32 m-b-50">
			<div class="col-xs-12 m-t-24 m-b-16 text-center">
				<h1 class="elite-title">Want to be a part of ELITE? </h1>
			</div>
		</div>
			...
			<div class="container">
				<div class="col-xs-12 col-sm-offset-1 col-sm-10 col-md-offset-2 col-md-8 col-lg-offset-3 col-lg-6">
					<form id="applyForm" name="applyForm" action="{{url('apply-job')}}" method="POST" enctype="multipart/form-data">
						...
						<input type="hidden" name="vacancyID" value="{{$vacancypost->id}}">
					...
					<div class="row m-t-24 message-height">
					...
					<div id="myModal" class="modal">
						...
						<div class="modal-content">
							...
							<div class="modal-body font-16 text-center">
								<p></p>
							</div>
						</div>
